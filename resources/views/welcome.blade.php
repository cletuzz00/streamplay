                        ...
                        <div class="col-xl-6 col-lg-12 col-md-12">
                           <a href="javascript:void(0);">
                              <div class="channel-logo" data-animation-in="fadeInLeft" data-delay-in="0.5">
                                 <img src="images/logo.png" class="c-logo" alt="hit400">
                              </div>
                           </a>
                           ...
                           <div class="d-flex align-items-center r-mb-23" data-animation-in="fadeInUp" data-delay-in="1.2">
                              <a href="{{route('login')}}" class="btn btn-hover"><i class="fa fa-play mr-2"
                                 aria-hidden="true"></i>Play Now</a>
                              <a href="{{route('login')}}" class="btn btn-link">More details</a>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="col-lg-4 r-mb-23">
                     <div class="text-left">
                        ...
                        <div class="parallax-buttons">
                           <a href="{{route('login')}}" class="btn btn-hover">Play Now</a>
                           <a href="{{route('login')}}" class="btn btn-link">More details</a>
                        </div>
                     </div>
                  </div>
               ...
               <div class="row">
                  <div class="col-sm-12 overflow-hidden">
                     <div class="iq-main-header d-flex align-items-center justify-content-between">
                        <h4 class="main-title"><a href="{{route('login')}}">Trending</a></h4>
                     </div>
                                          ...
                                          <div class="trending-info align-items-center w-100 animated fadeInUp">
                                             ...
                                             <div class="p-btns">
                                                <div class="d-flex align-items-center p-0">
                                                   <a href="{{route('login')}}" class="btn btn-hover mr-2" tabindex="0"><i
                                             ...
                                             <div class="episodes-contens mt-4">
                                                <div class="owl-carousel owl-theme episodes-slider1 list-inline p-0 mb-0">
                                                   <div class="e-item">
                                                      <div class="block-image position-relative">
                                                         ...
                                                         <div class="episode-play-info">
                                                            <div class="episode-play">
                                                               <a href="{{route('login')}}" tabindex="0"><i
                                                      ...
                                                      <div class="episodes-description text-body mt-2">
                                                         <div class="d-flex align-items-center justify-content-between">
                                                            <a href="{{route('login')}}">Episode 1</a>
                                                   ...
                                                   <div class="e-item">
                                                      ...
                                                      <div class="episodes-description text-body mt-2">
                                                         <div class="d-flex align-items-center justify-content-between">
                                                            <a href="{{route('login')}}">Episode 2</a>
                                                   ...
                                                   <div class="e-item">
                                                      ...
                                                      <div class="episodes-description text-body mt-2">
                                                         <div class="d-flex align-items-center justify-content-between">
                                                            <a href="{{route('login')}}">Episode 3</a>
                                                   ...
                                                   <div class="e-item">
                                                      ...
                                                      <div class="episodes-description text-body mt-2">
                                                         <div class="d-flex align-items-center justify-content-between">
                                                            <a href="{{route('login')}}">Episode 4</a>
                                                   ...
                                                   <div class="e-item">
                                                      ...
                                                      <div class="episodes-description text-body mt-2">
                                                         <div class="d-flex align-items-center justify-content-between">
                                                            <a href="{{route('login')}}">Episode 5</a>
         ...
         <section id="iq-tvthrillers" class="s-margin">
            <div class="container-fluid">
               <div class="row">
                  <div class="col-sm-12 overflow-hidden">
                     <div class="iq-main-header d-flex align-items-center justify-content-between">
                        <h4 class="main-title"><a href="{{route('login')}}">TV Thrillers</a></h4>
                     </div>
